...
# This script is targeted for Windows 2012R2/2016/2019
#  
...
if ([System.Version]$os.Version -lt [System.Version]'10.0') {
  ...
  $cipherSuitesOrder = @(
    ...
    #CBC implementations in TLS have shown themselves to be vulnerable, 
    #and each time an implementation is fixed, it seems yet another bug 
    #making padding oracle attacks feasible appears.
...
# This key may not exist on Windows 2012R2. 
